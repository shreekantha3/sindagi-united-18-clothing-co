# United 18 Clothing Co — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-united-18-clothing-co/
- **Repo:** `shreekantha3/sindagi-united-18-clothing-co` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-united-18-clothing-co/'` for GitHub Pages project-site hosting.
